...
![GSFLib Functions](figures/lib-figure-1-1.svg "GSFLib Functions")
...
#### 4.1.2.2 Multibeam Sensor-specific Subrecords
    ...
    ***********************************************************************************/
    ...
    typedef struct t_gsfEMRunTime
    {
        ...
        unsigned char xoperator_station_status;  /* Bit mask of status information for operator station */
        ...
        /* one byte bit mask defining SSV source -> 0=sensor, 1=manual, 2=profile */
        int max_port_swath_width;  /* total swath width to port side in meters */
        unsigned char beam_spacing;
        /* one byte bit mask -> 0=beamwidth, 1=equiangle, 2=equidistant, 3=intermediate */
        ...
        /* Sound speed in durotong for the EM1002 transducer, zero if not available */
        double hi_low_absorption_ratio;  /* Absorption coeffieceint ratio */
        double tx_along_tilt;
        * Transmit fan along track tilt angle in degrees */
    ...
    typedef struct t_gsfEMPUStatus
    {
        ...
        sensor_status;  /* Bit mask containing status of sensor
        int achieved_port_coverage;
        /* Achieved coverage to port in degrees */
        int achieved_stbd_coverage;
        /* Achieved coverage to starboard in in degrees */
    ...
    typedef struct t_gsfEM4Specific
    {
        ...
        double surface_velocity;
        /* Measured sound speed near the surface in m/s */
        double transducer_depth;
        /* The transmit transducer depth in meters re water level at ping time */
        ...
        /* From 0x66 datagram, non-zero when sonar head is mounted on a sub-sea platform */
        unsigned char spare_1[16];
        int transmit_sectors;
        /* The number of transmit sectors for this ping */
    ...
    typedef struct t_gsfKlein5410BssSpecific
    {
        ...
        num_raa_samples;  /* number of valid range, angle, amplitude
        unsigned int error_flags;  /* error flags for this ping */
        unsigned int range;  /* sonar range setting */
        fish_depth;  /* reading from the towfish pressure sensor
        fish_altitude;  /* towfish altitude in m */
        sound_speed;  /* speed of sound at the transducer face in
    ...
    typedef struct t_gsfDeltaTSpecific
    {
        ...
        /* the velocity of sound at the transducer face in m/s */
        double range_resolution;
        /* range resolution in centimeters (documentation says mm but all example data is in cm) */
        ...
        /* this tells whether the GSF will have actual ping in seconds */
        double ping_latency;
        /* time from sonar ping interrogation to 83P UDP datagram in seconds */
        double data_latency;
        ...
        double athwartships_beamwidth;  /* Effective athwartships beam width indouble degrees */
    ...
    typedef struct t_gsfR2SonicSpecific
    {
        ...
        float ping_period;  /* Time interval between two most recent pings, seconds */
        ...
        float tx_steering_vert;  /* fore-aft beam steering angle, radians, -pi to +pi */
        float tx_steering_horiz;  /* athwartship beam steering angle, radians, -pi to +pi */
        ...
        float rx_gain;  /* receiver gain setting, 2dB increments between steps */
        float rx_spreading;  /* TVG spreading law coefficient, e.g. 20log10(range) */
        ...
        float A0_more_info[6];  /* Additional fields associated with equi-angular mode; first element of array is roll */

        float A2_more_info[6];  /* Additional fields associated with equi-distant mode; first element of array is roll */
...
GSF_SWATH_BATHY_SUBRECORD_EM3000_SPECIFIC | gsfEM3Specific
GSF_SWATH_BATHY_SUBRECORD_EM1002_SPECIFIC | gsfEM3Specific
GSF_SWATH_BATHY_SUBRECORD_EM300_SPECIFIC | gsfEM3Specific
GSF_SWATH_BATHY_SUBRECORD_EM120_SPECIFIC | gsfEM3Specific
GSF_SWATH_BATHY_SUBRECORD_EM3002_SPECIFIC | gsfEM3Specific
GSF_SWATH_BATHY_SUBRECORD_EM3000D_SPECIFIC | gsfEM3Specific
GSF_SWATH_BATHY_SUBRECORD_EM3002D_SPECIFIC | gsfEM3Specific
GSF_SWATH_BATHY_SUBRECORD_EM121A_SIS_SPECIFIC | gsfEM3Specific
GSF_SWATH_BATHY_SUBRECORD_EM2000_SPECIFIC | gsfEM3Specific
GSF_SWATH_BATHY_SUBRECORD_RESON_8101_SPECIFIC | gsfReson8100Specific
GSF_SWATH_BATHY_SUBRECORD_RESON_8111_SPECIFIC | gsfReson8100Specific
GSF_SWATH_BATHY_SUBRECORD_RESON_8124_SPECIFIC | gsfReson8100Specific
GSF_SWATH_BATHY_SUBRECORD_RESON_8125_SPECIFIC | gsfReson8100Specific
GSF_SWATH_BATHY_SUBRECORD_RESON_8150_SPECIFIC | gsfReson8100Specific
GSF_SWATH_BATHY_SUBRECORD_RESON_8160_SPECIFIC | gsfReson8100Specific
GSF_SWATH_BATHY_SUBRECORD_GEOSWATH_PLUS_SPECIFIC | gsfGeoSwathPlusSpecific
GSF_SWATH_BATHY_SUBRECORD_EM710_SPECIFIC | gsfEM4Specific
GSF_SWATH_BATHY_SUBRECORD_EM302_SPECIFIC | gsfEM4Specifci
GSF_SWATH_BATHY_SUBRECORD_EM122_SPECIFIC | gsfEM4Specific
GSF_SWATH_BATHY_SUBRECORD_EM2040_SPECIFIC | gsfEM4Specific
...
GSF_SWATH_BATHY_SUBRECORD_EM1002_RAW_SPECIFIC | gsfEM3RawSpecific
GSF_SWATH_BATHY_SUBRECORD_EM2000_RAW_SPECIFIC | gsfEM3RawSpecific
GSF_SWATH_BATHY_SUBRECORD_EM3000_RAW_SPECIFIC | gsfEM3RawSpecific
GSF_SWATH_BATHY_SUBRECORD_EM120_RAW_SPECIFIC | gsfEM3RawSpecific
GSF_SWATH_BATHY_SUBRECORD_EM3002_RAW_SPECIFIC | gsfEM3RawSpecific
GSF_SWATH_BATHY_SUBRECORD_EM3000D_RAW_SPECIFIC | gsfEM3RawSpecific
GSF_SWATH_BATHY_SUBRECORD_EM3002D_RAW_SPECIFIC | gsfEM3RawSpecific
GSF_SWATH_BATHY_SUBRECORD_EM121A_SIS_RAW_SPECIFIC | gsfEM3RawSpecific
GSF_SWATH_BATHY_SUBRECORD_DELTA_T_SPECIFIC | gsfDeltaTSpecific
GSF_SWATH_BATHY_SUBRECORD_R2SONIC_2020_SPECIFIC | gsfR2SonicSpecific
GSF_SWATH_BATHY_SUBRECORD_R2SONIC_2022_SPECIFIC | gsfR2SonicSpecific
GSF_SWATH_BATHY_SUBRECORD_R2SONIC_2024_SPECIFIC | gsfR2SonicSpecificx
...
#### 4.1.2.3 Bathymetric Receive Beam Time Series Intensity Subrecord
    ...
    typedef struct t_gsfBRBIntensity
    {
        ...
        gsfTimeSeriesIntensity *time_series;  /* array of per-beam time series intensity records */
    } gsfBRBIntensity;
    ...
    typedef struct t_gsfEM3ImagerySpecific
    {
        ...
        short scale;  /* Manufacturer's specified scale value for each sample. This value is 2 for data from EM3000EM3002/EM1002/EM300/EM120 */
    ...
    typedef struct t_gsfEM4ImagerySpecific
    {
        ...
        /* The system digitizing rate in Hz, value retrieved from the imagery datagram */
        ...
        short offset;
        /* Value that has been added to all imagery samples to convert to a positive value */
    ...
    typedef struct t_gsfKlein5410BssImagerySpecific
    {
        ...
        unsigned char spare[4];  /* reserved for future expansion */
    ...
    typedef struct t_gsfR2SonicImagerySpecific
    {
        ...
        unsigned short reserved;  /* reserved for future use */
        unsigned short num_beams;  /* number of beams in this ping */
        float more_info[6];  /* reserved for future use, from SNI0 datagram */
        unsigned spare[32];  /* saved for future expansion */
    } t_gsfR2SonicImagerySpecific;

    typedef union t_gsfSensorImagery
    {
        t_gsfEM3ImagerySpecific gsfEM3ImagerySpecific;  /* used for EM120, EM300, EM1002, EM3000, EM3002, and EM121A_SIS */
...
#### 4.1.3.1 Single-beam Sensor-specific Subrecords
    ...
    typedef struct t_gsfEchotracSpecific
    {
        ...
        unsigned short tide_source;  /* Flag To determine if nav was mpp */
...
#### 4.1.5.1 Internal Structure for Processing Parameters
    ...
    #define GSF_UNKNOWN_PARAM_VALUE DBL_MIN
    #define GSF_TRUE 1
    #define GSF_FALSE 0
    ...
    #define GSF_PLATFORM_TYPE_SURFACE_SHIP 0  /* Add for AUV vs Surface Ship discrimination */
    #define GSF_PLATFORM_TYPE_AUV 1  /* Add for AUV vs Surface Ship discrimination */
    ...
    typedef struct t_gsfMBParams
    {
        ...
        int vertical_datum;
        int utc_offset;  /* Offset in hours from UTC to local time of collection. */
        ...
        int roll_reference;  /* = roll is horizontal or rotated pitch axis */
        ...
        int ray_tracing;  /* = GSF_COMPENSATED if travel time/angle pairs are compensated for ray tracing */
        ...
        int full_raw_data;  /* = GSF_TRUE all data required for full recalculation */
        int msb_applied_to_attitude;  /* = GSF_TRUE if contains motion sensor biases */
        int heave_removed_from_gps_tc;
        /* = GSF_TRUE if heave removed from gps_tide_corrector */
         ...
         * corrected for.
         */
        gsfMBOffsets to_apply;  /* These parameters specify offsets which have already been corrected. */
...
Note: As of GSF v1.07, the gsfNavigationError record has been replaced
by gsfHVNavigationError.  All newly created files should be written
using gsfHVNavigationError, instead of gsfNavigationError.
    ...
    typedef struct t_gsfHVNavigationError
    {
        ...
        char *position_type;  /* 4 character string code specifying type of positioning system */
...
### 4.2.3 Null values used to represent missing data
     ...
     * The beam flags array should be used to determine data validity.
     */
